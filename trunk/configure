...
if test "${lt_cv_nm_interface+set}" = set; then :
  ...
  (eval echo "\"\$as_me:5458: $ac_compile\"" >&5)
  (eval "$ac_compile" 2>conftest.err)
  cat conftest.err >&5
  (eval echo "\"\$as_me:5461: $NM \\\"conftest.$ac_objext\\\"\"" >&5)
  (eval "$NM \"conftest.$ac_objext\"" 2>conftest.err > conftest.out)
  cat conftest.err >&5
  (eval echo "\"\$as_me:5464: output\"" >&5)
  cat conftest.out >&5
...
if test "x$ac_cv_type___int32" = x""yes; then :
...
if test "x$ac_cv_header_libkern_OSByteOrder_h" = x""yes; then :
  cat >>confdefs.h <<_ACEOF
...
if test "x$ac_cv_header_sys_isa_defs_h" = x""yes; then :
  cat >>confdefs.h <<_ACEOF
...
if test "${ac_cv_interlocked_exchange_nonvolatile+set}" = set; then :
  $as_echo_n "(cached) " >&6
else
